...
# from swmm_rl_hague.hague_ddpg_Model_gwl import BasicEnv
...
mem_dir = "C:/PycharmProjects/swmm_rl_hague/tuning/agent_memory"

# swmm_file = "C:/PycharmProjects/swmm_rl_hague/hague_inp_files_pyswmm/hague_v22_simpleRL.inp"
swmm_file = "C:/PycharmProjects/swmm_rl_hague/hague_inp_files_pyswmm/hague_v22_simpleRL_resus.inp"  # inp with modified TSS resuspension
# swmm_file = "C:/PycharmProjects/swmm_rl_hague/hague_inp_files_pyswmm/hague_v22_simpleRL_noresus.inp"  # inp without TSS resuspension
# swmm_file = "C:/PycharmProjects/swmm_rl_hague/hague_inp_files_pyswmm/hague_v22_simpleRL_gw.inp"  # inp with gw
fcst = "C:/Users/Ben Bowes/Documents/LongTerm_SWMM/hague_fcst_2010_2019_dated.csv"
gwl = "C:/Users/Ben Bowes/Documents/HRSD GIS/Site Data/Data_2010_2019/IDW_2010_2019.csv"
env = BasicEnv(inp_file=swmm_file, fcst_file=fcst)  # env with forecasts
# env = BasicEnv(inp_file=swmm_file, fcst_file=fcst, gwl_file=gwl)  # env with forecasts and gwl
...
# memory = pickle.load(open(os.path.join(mem_dir, 'ddpg_mem_100000_rwd39_config26'), 'rb'))
...
random_process = GaussianWhiteNoiseProcess(mu=0., sigma=1., sigma_min=.01, n_steps_annealing=train_steps, size=nb_actions)  # sigma decreasing from 1 to 0 in 1000steps?
agent = DDPGAgent(nb_actions=nb_actions, actor=actor, critic=critic, critic_action_input=action_input,  # get sigma/noise from here?
                  ...
                  random_process=random_process, gamma=.99, target_model_update=1e-3)  # original gamma = 0.99
...
# agent.load_weights('C:/PycharmProjects/checkpoint_reward_best_config39_50k.h5f')
...
wb_config = {'rwd': rwd_num, 'steps': train_steps, "nets": "(50, 25)", "lr": 0.001, "noise": "gaussian",
             'seed': "(22, 54321, 4321)", 'activation': 'relu', 'annealing': train_steps, 'sigma_min': 0.01,
             'rwd threshold': 0.5, 'memory len': train_steps, 'sigma': 1, 'start steps': 50, 'gamma': .99}  # , 'dry rwd': 'with system flooding/35000'
...
agent.save_weights('C:/PycharmProjects/swmm_rl_hague/tuning/agent_weights/ddpg_weights_{}_config{}.h5f'.format(train_steps, config_num),
                   overwrite=True)
...
history = agent.test(env, nb_episodes=1, visualize=False, nb_max_start_steps=0)  # test on train data w/o exploration
env.close()
...
rpt_df.to_csv("C:/PycharmProjects/swmm_rl_hague/tuning/results/ddpg_{}steps_rwd{}_config{}_122012_modresus.csv".format(train_steps,
                                                                                                 rwd_num, config_num),
              index=True)
...
test_dir = "C:/PycharmProjects/swmm_rl_hague/hague_inp_files_test"
result_dir = "C:/PycharmProjects/swmm_rl_hague/results_alldata/rl_all_config19_150k_mass"
...
for file in test_files:
    if file.endswith('.inp'):
        ...
        rpt_df.to_csv(os.path.join(result_dir,
                                   "ddpg_{}steps_rwd{}_test{}_config19_mass.csv".format(train_steps, rwd_num,
