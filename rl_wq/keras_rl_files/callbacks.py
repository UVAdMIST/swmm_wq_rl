...
class WandbLogger(Callback):
    ...
    def on_episode_end(self, episode, logs):
        ...
        # Save weights if the episode reward is higher than previous
        if np.sum(self.rewards[episode])>self.lastreward:
            ...
            print("The reward is higher than the best one, saving checkpoint weights to ", os.path(previousWeights))
