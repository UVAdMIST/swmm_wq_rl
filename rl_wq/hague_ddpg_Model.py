...
class BasicEnv(Env):
    ...
    def step(self, action):
        ...
        # # 40 conditional with pollutants reward
        # if self.St3.depth > 5.75:  # penalize st3 if above upstream flood threshold
        #     st3_depth_rwd = 1000
        # else:
        #     st3_depth_rwd = 0
        ...
        #                 (current_r1_cum_tss - r1_cum_tss) + (current_r3_cum_tss - r3_cum_tss))
        # else:
        #     reward = - (abs(self.St1.depth - 6.) + abs(self.St3.depth - 3.56) * 2 +
        #                 (current_r1_cum_tss - r1_cum_tss) + (current_r3_cum_tss - r3_cum_tss) +
        #                 (current_cum_fld - cum_fld)/35000)

        # # 44 conditional with pollutants reward
        # if self.St3.depth > 5.75:  # penalize st3 if above upstream flood threshold
        #     st3_depth_rwd = 1000
        # else:
        #     st3_depth_rwd = 0
        # if self.St3.depth < 2.:  # penalize if st3 below 2ft
        #     st3_min_rwd = 1000
        # else:
        #     st3_min_rwd = 0
        #
        ...
        #                 (current_r1_cum_tss - r1_cum_tss) + (current_r3_cum_tss - r3_cum_tss))
        # else:
        #     reward = - (abs(self.St1.depth - 6.) + abs(self.St3.depth - 3.56) + st3_min_rwd +
        #                 (current_r1_cum_tss - r1_cum_tss) + (current_r3_cum_tss - r3_cum_tss) +
        #                 (current_cum_fld - cum_fld)/35000)

        # # 46 conditional with pollutants, target range, st3 min
        # if self.St3.depth > 5.75:  # penalize st3 if above upstream flood threshold
        #     st3_depth_rwd = 1000
        # else:
        #     st3_depth_rwd = 0
        ...
        #     st3_dev_rwd = 0
        # else:
        #     st3_dev_rwd = abs(self.St3.depth - 3.56) * 2
        #
        # if rain_fcst > 0.5 or past_rain > 0.1:  # check if rainfall forecast is positive
        #     reward = - ((current_cum_fld - cum_fld) + self.St1.flooding * 1000 + st3_depth_rwd +
        #                 (current_r1_cum_tss - r1_cum_tss) + (current_r3_cum_tss - r3_cum_tss))
        # else:
        #     reward = - (st1_dev_rwd + st3_dev_rwd + st3_min_rwd +
        #                 (current_r1_cum_tss - r1_cum_tss) + (current_r3_cum_tss - r3_cum_tss) +
        #                 (current_cum_fld - cum_fld) / 35000)
