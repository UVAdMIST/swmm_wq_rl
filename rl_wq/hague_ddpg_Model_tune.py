...
class BasicEnv(Env):
    ...
    def step(self, action):
        ...
        # reward = - ((current_cum_fld - cum_fld) + abs(self.St3.depth - 3.56) + abs(self.St1.depth - 6.))
        ...
        # # 34 system flood and pollutant load reward, normalized to passive system max values
        # reward = - ((current_cum_fld - cum_fld)/79198.6 + (current_outfall_cum_tss - outfall_cum_tss)/94.1)

        # # 37 system flood and pollutant load reward, normalized to passive system max values
        # reward = - ((current_cum_fld - cum_fld)/79198.6 + (current_outfall_cum_tss - outfall_cum_tss)/94.1 +
        #             abs(r1_act_new - r1_expert) + abs(r3_act_new - r3_expert))

        # # 38 conditional with pollutants reward
        # if self.St3.depth > 5.75:  # penalize st3 if above upstream flood threshold
        #     st3_depth_rwd = 1000
        # else:
        #     st3_depth_rwd = 0
        ...
        # else:
        #     reward = - (abs(self.St1.depth - 6.) + abs(self.St3.depth - 3.56) +
        #                 (current_cum_fld - cum_fld)/79198.6)
        ...
        # # 40 conditional with pollutants and past rain
        # if self.St3.depth > 5.75:  # penalize st3 if above upstream flood threshold
        #     st3_depth_rwd = 1000
        # else:
        #     st3_depth_rwd = 0
        #
        # if rain_fcst > 0.5 or past_rain >= 0.1:  # check if rainfall forecast is positive
        #     reward = - ((current_cum_fld - cum_fld) + self.St1.flooding * 1000 + st3_depth_rwd +
        #                 (current_r1_cum_tss - r1_cum_tss) + (current_r3_cum_tss - r3_cum_tss))
        # else:
        #     reward = - (abs(self.St1.depth - 6.) + abs(self.St3.depth - 3.56) +
        ...
        # # 41 conditional no TSS
        # if self.St3.depth > 5.75:  # penalize st3 if above upstream flood threshold
        #     st3_depth_rwd = 1000
        # else:
        #     st3_depth_rwd = 0
        #
        # if 5.5 <= self.St1.depth <= 6.5:
        #     st1_dev_rwd = 0
        # else:
        #     st1_dev_rwd = abs(self.St1.depth - 6.)
        #
        # if 3.06 <= self.St3.depth <= 4.06:
        #     st3_dev_rwd = 0
        # else:
        #     st3_dev_rwd = abs(self.St3.depth - 3.56)
        #
        # if rain_fcst > 0.5:  # check if rainfall forecast is positive
        #     reward = - ((current_cum_fld - cum_fld) + self.St1.flooding * 1000 + st3_depth_rwd)
        # else:
        #     reward = - (st1_dev_rwd + st3_dev_rwd)

        # # 42 conditional with pollutants reward
        # if self.St3.depth > 5.75:  # penalize st3 if above upstream flood threshold
        #     st3_depth_rwd = 1000
        # else:
        #     st3_depth_rwd = 0
        ...
        # # 43 conditional with pollutants reward
        # if self.St3.depth > 5.75:  # penalize st3 if above upstream flood threshold
        #     st3_depth_rwd = 1000
        # else:
        #     st3_depth_rwd = 0
        ...
        #     reward = - ((current_cum_fld - cum_fld) + self.St1.flooding * 1000 + st3_depth_rwd)
        # else:
        #     reward = - (st1_dev_rwd + st3_dev_rwd + (current_r1_cum_tss - r1_cum_tss))

        # # 45 conditional with pollutants and past rain
        # if self.St3.depth > 5.75:  # penalize st3 if above upstream flood threshold
        #     st3_depth_rwd = 1000
        # else:
        #     st3_depth_rwd = 0
